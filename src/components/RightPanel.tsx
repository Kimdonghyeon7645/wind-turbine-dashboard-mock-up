const RightPanel = () => {
  return (
    ...
    bg-[#00000077] backdrop-blur-xl rounded-lg text-white tracking-tight"
      ...
      <div
        className="
        mt-1 py-2.5 px-3.5 flex flex-col gap-2.5
    bg-[#00000077] backdrop-blur-xl rounded-lg tracking-tight text-white"
      >
        ...
        <div className="ml-[-15px] w-[calc(100%+27px)] px-3.5 h-[calc(100svh-280px)] overflow-auto cus-scroll">
        ...
        <div className="h-14 -ml-1 w-[calc(100%+8px)]">
          ...
          <div className="text-[#ffffff33] mt-px text-[.75rem] font-light tracking-tight px-1.5 flex justify-end gap-1">
            <div>
              <span className="text-[#ffffff55]">[MockUp]</span> 2025.11.13
            </div>
            <div>·</div>
            <div>
